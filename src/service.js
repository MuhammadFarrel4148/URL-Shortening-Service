...
const getURLStatistics = async(request, response) => {
    const { shortURLParams } = request.params;
        ...
        if(existShortURL.length > 0) {
            return response.status(200).json({
                ...
                result: {
                    ...
                    createdAt: existShortURL[0].createdAt, 
                    updatedAt: existShortURL[0].updatedAt, 
                    accessCount: existShortURL[0].accessCount
                }
            });
        };
...
module.exports = { createShortURL, retrieveShortURL, updateShortURL, deleteShortURL, getURLStatistics };